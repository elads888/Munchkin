...
void printPlayerLost(std::unique_ptr<Player>& player){
    std::cout << player->getName() << " is out of the game :("<< std::endl;
}

void printPlayerWon(std::unique_ptr<Player>& player){
    std::cout << player->getName() << " WON and now will sit aside :)"<< std::endl;
}
/* ---------------------------------------------------------------------------------------------- */
...
void printCurrentCard(std::string &  card_name){
    std::cout << "The card that was drawn is a" << card_name << " card"<< std::endl;
}
...
void printStartGameMessage() {
    cout << "Welcome to the world of Munchkin!!!" << endl;
}
